...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL, KC_LALT, KC_LGUI, TMUX,    LOWER,   KC_SPC,  KC_SPC,  RAISE,   NAV,     KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_ADJUST] = LAYOUT_preonic_grid(
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    KC_WAKE, RESET,   DEBUG,   _______, _______, _______, _______, _______, _______, _______, MU_TOG,  _______, \
    KC_SLEP, _______, MU_MOD,  _______, _______, AG_NORM, AG_SWAP, _______, _______, _______, AU_TOG,  _______, \
...
// do I need to keep this if there's nothing in it?
