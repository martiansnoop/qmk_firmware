...
/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * | Wake | Reset| Debug|      |      |      |      |      |      |      |Mu tog|Qwerty|
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Sleep|      |      |      |      |AGnorm|AGswap|      |      |      |Au tog|Plover|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |Voice-|Voice+|      |      |      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      |      |      |      |      |
...
[_ADJUST] = LAYOUT_planck_grid(
    KC_WAKE, RESET,   DEBUG,   _______, _______, _______, _______, _______, _______, _______, MU_TOG,  QWERTY,
    KC_SLEP, _______, MU_MOD,  _______, _______, AG_NORM, AG_SWAP, _______, _______, _______, AU_TOG,  PLOVER,
